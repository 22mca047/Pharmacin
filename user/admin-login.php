...
if($_POST)
{
    ...
    $selectq = mysqli_query($connection,"select * from tbl_admin where admin_email='{$email}' and admin_password ='{$password}'") or die(mysqli_error($connection));
    ...
    if($count>0)
    {
        ...
        $_SESSION['adminimage'] = $row['admin_image'];
        
        echo "<script>alert('You Have Successfully Logged In..');window.location='../admin/dashboard.php';</script>";
     }
     else
     {
         echo "<script>alert('Password Is Case Sensetive Please Re-enter Again..');window.location='admin-login.php';</script>";
     }
...
<html lang="en">
    <head>
        ...
        <!-- PAGE TITLE HERE -->
        <title>PHARMACIN - Admin Login</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="p-a30 m-b30 border-2 contact-area align-self-stretch">
                                    <h3 class="form-title m-t0" style="text-align:center;">Admin Login</h3>
                                    ...
                                    <div class="form-group" style="margin-left:100px; width:100%;">
                                    ...
                                    <div class="form-group text-left pass-check">
                                        <a  href="admin-forgotpassword.php" class="m-l15"><i class="fa fa-unlock-alt"></i> Forgot Password</a> 
                                    </div>
                                </div>
                                </form>
                            </div>
