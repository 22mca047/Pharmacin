...
//Create an instance; passing `true` enables exceptions
        ...
        try {
            ...
            $mail->Body = "Hi $email Your Password is {$row['vendor_password']}";
            $mail->AltBody = "Hi $email Your Password is {$row['vendor_password']}";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="p-a30 m-b30 border-2 contact-area align-self-stretch">
                                    <h3 class="form-title m-t0" style="text-align:center;">Forgot Password</h3>
                                    ...
                                    <div class="form-group" style="margin-left:50px;">
                                        ...
                                        <button type="button" class="site-button dz-xs-flex col-lg-5 text-center" onclick="window.location='vendor-login.php';">Back</button>
                                    </div>
                                </div>
                                </form>
                            </div>
