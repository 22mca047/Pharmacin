                ...
                <div class="content-area">
                    ...
                    <div class="container woo-entry">
                        ...
                        <table class="table table-bordered" style="text-align:center;">
                            ...
                            {
                                $select1 = $proven['vendor_id'] == $_GET['vid'] ? "<b>{$proven['shop_name']}</b>" : "{$proven['shop_name']}" ;
                                $select2 = $proven['vendor_id'] == $_GET['vid'] ? "<b>{$proven['vendor_name']}</b>" : "{$proven['vendor_name']}" ;
                                $select3 = $proven['vendor_id'] == $_GET['vid'] ? "<b>{$proven['area_pincode']}</b>" : "{$proven['area_pincode']}" ;
                                $select4 = $proven['vendor_id'] == $_GET['vid'] ? "<b>{$proven['pro_ven_price']}</b>" : "{$proven['pro_ven_price']}" ;
                                $select5 = $proven['vendor_id'] == $_GET['vid'] ? "<b>{$proven['pro_qty']}</b>" : "{$proven['pro_qty']}" ;
                                ...
                                echo "<tr>
                                    ...
                                    <div class='quantity btn-quantity pull-left m-r10' >
                                        ...
                                        <div style='padding-left:20px;'><input id='$select1' type='number' value='1' name='demo_vertical2' min='1' max='{$proven['pro_qty']}' required/>
