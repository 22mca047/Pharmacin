...
FROM
    ...
    INNER JOIN `tbl_vendor` 
        ON (`tbl_area`.`area_id` = `tbl_vendor`.`area_id`) where `tbl_vendor`.`is_verified` = 1";
                    ...
                    <div class="row page-titles mx-0">
                        ...
                        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="add-vendor.php">Add Vendor</a></li>
                            </ol>
                        </div>
                    </div>
                    <!-- row -->
                                                ...
                                                while ($vendorrow = mysqli_fetch_array($selectq))
                                                {
                                                    ...
                                                    echo "<td><div class='dropdown custom-dropdown mb-0'>
                                                            ...
                                                            <div class='dropdown-menu dropdown-menu-right'>
                                                                <a class='dropdown-item text-dark' href='vendorprofile.php?eid={$vendorrow['vendor_id']}'><img src='upload/ani_icons/seemore.gif' style='height:34px;width:50px;' />See More</a>
                                                                <a class='dropdown-item text-primary' href='edit-vendor.php?vid={$vendorrow['vendor_id']}'><img src='upload/ani_icons/edit.gif' style='height:34px;width:50px;padding-left:7px;' />Edit</a>
