...
<html lang="en">
    ...
    <head>
        ...
        <title>PHARMACIN -Add Category</title>
        <!-- Favicon icon -->
                                    ...
                                    <form action="#" method="post" id="myform">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="catname" id="add-name" required>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <button type="submit" class="btn btn-success" style="margin-left: -1px;margin-right: -11px;">Add Category
                                            </button>
                                            <button type="reset" class="btn btn-danger" style="margin-right: -12px;">Reset
                                            </button>
                                            <button type="button" onclick="window.location = 'manage-category.php'"; class="btn btn-info">view
                                            </button>
                                        </div>
                                    </form>
                                </div>
