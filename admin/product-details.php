                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered" >
                            ...
                            <?php
                            while ($proven1 = mysqli_fetch_array($vendorproductq))
                            {
                                echo "<tr>
                                    <td>{$proven1['shop_name']}</td>
                                    <td>{$proven1['vendor_name']}</td>
                                    <td>{$proven1['area_pincode']}</td>
                                    <td>{$proven1['pro_ven_price']}</td>
                                    <td>{$proven1['pro_qty']}</td>
