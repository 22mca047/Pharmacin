                                        ...
                                        <tbody>
                                          ...
                                          if (isset($_GET['did'])) {
                                                ...
                                                while ($feedbackrow = mysqli_fetch_array($selectq)) {
                                                    ...
                                                    echo "<td>{$feedbackrow['vendor_name']}</td>";
                                                    ...
                                                    echo "<td><div class='dropdown custom-dropdown mb-0'>
                                                            ...
                                                            <div class='dropdown-menu dropdown-menu-right'>
                                                                 ...
                                                                 <a class='dropdown-item text-danger' href='manage-feedback.php?did={$feedbackrow['feedback_id']}'><img src='upload/ani_icons/delete.gif' style='height:34px;width:50px;' /> Delete</a>
                                                            </div>
                                                        </div></td>";
                                                    echo "</tr>";
                                                }
